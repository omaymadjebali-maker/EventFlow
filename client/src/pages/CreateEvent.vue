    ...
    <div class="create-shell">
      <section class="create-showcase">
        <div class="showcase-content">
          <span class="showcase-kicker">EventFlow · Espace organisateur</span>

          <h1>
            Créez un événement clair, attractif et prêt à être publié en quelques étapes.
          </h1>

          <p>
            Structurez les informations essentielles, définissez la capacité et préparez une fiche
            cohérente avec l’expérience SaaS du reste de la plateforme.
          </p>
          ...
          <div class="showcase-points">
            <div class="point-card">
              ...
              <div>
                ...
                <p>Renseignez l’essentiel dans un formulaire fluide et lisible.</p>
              </div>
            </div>
            ...
            <div class="point-card">
              ...
              <div>
                <strong>Infos bien structurées</strong>
                <p>Le lieu, la date et la capacité restent immédiatement compréhensibles.</p>
              </div>
            </div>
            ...
            <div class="point-card">
              ...
              <div>
                ...
                <p>Une présentation plus nette aide à éviter les erreurs de saisie.</p>
              </div>
            </div>
          </div>
          ...
          <div class="tips-card">
            ...
            <p>
              Un bon titre, un lieu précis et une capacité réaliste améliorent immédiatement la qualité
              du dashboard et des inscriptions.
            </p>
          </div>
        </div>
      </section>

      <section class="create-card-wrapper">
        <div class="create-card">
          <div class="create-card-header">
            <div class="brand-mark">E</div>
            <div>
              <h2>Nouvel événement</h2>
              <p>Renseignez les détails de votre événement avant publication.</p>
            </div>
          </div>

          <form @submit.prevent="onSubmit" class="create-form" novalidate>
            <div class="field-group">
              ...
              <p class="field-hint">Choisissez un titre court, descriptif et facile à repérer dans le dashboard.</p>
            ...
            <div class="capacity-section">
              <div class="capacity-copy">
                ...
                <p class="field-hint">Définissez le nombre maximum de participants autorisés.</p>
              </div>
            ...
            <div class="summary-card">
              <span class="summary-badge">Aperçu rapide</span>
...
async function onSubmit() {
  ...
  try {
    ...
    msg.value = "Événement créé avec succès !";
...
.create-showcase > .showcase-content > p {
  margin: 0;
  max-width: 620px;
  font-size: 1rem;
  line-height: 1.75;
