    ...
    <div class="register-shell">
      <section class="register-showcase">
        <div class="showcase-content">
          ...
          <h1>
            Créez votre compte et rejoignez une expérience événementielle claire et moderne.
          </h1>

          <p>
            Créez votre compte participant, accédez à votre espace personnel et commencez à suivre
            les événements disponibles dans une interface cohérente avec le reste de la plateforme.
          </p>
          ...
          <div class="showcase-points">
            <div class="point-card">
              ...
              <div>
                ...
                <p>Inscription fluide avec un parcours simple et lisible.</p>
              </div>
            </div>
            ...
            <div class="point-card">
              <span class="point-icon">🧭</span>
              <div>
                <strong>Compte participant</strong>
                <p>L’inscription publique crée un compte standard pour consulter et rejoindre des événements.</p>
              </div>
            </div>
            ...
            <div class="point-card">
              ...
              <div>
                ...
                <p>Vos identifiants sont gérés dans le même environnement sécurisé que la connexion.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="register-card-wrapper">
        <div class="register-card">
          <div class="register-card-header">
            ...
            <p>Renseignez vos informations pour accéder à EventFlow.</p>
          </div>
          ...
          <form class="register-form" @submit.prevent="onSubmit">
            ...
            <div class="field-group">
              ...
              <p class="field-hint">Utilisez au moins 6 caractères pour sécuriser votre compte.</p>
            </div>
...
.register-showcase > .showcase-content > p {
  margin: 0;
  max-width: 620px;
  font-size: 1rem;
  line-height: 1.75;
